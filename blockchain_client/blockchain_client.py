...
# # listen request to an any request from this slash ("/")
# # remember response should be json
#
...
#
#     response = {
#         'private_key_res': binascii.hexlify(private_key.export_key(format('DER'))).decode('ascii'),
#         'public_key_res': binascii.hexlify(public_key.export_key(format('DER'))).decode('ascii')
#     }
#
#     return jsonify(response), 200
#
